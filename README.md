...
4. نام، توضیح، قیمت و اطلاعات لازم باسلام مثل موجودی، وزن و زمان آماده‌سازی را در صفحه بازبینی اصلاح کن.
5. اگر خواستی، محصول‌ها را در غرفه باسلام ثبت کن.

اطلاعات فروشگاه اختیاری است و در یک بخش بسته قرار دارد. اگر کاربر بدون ویس لیست بسازد و بعدا ببیند اطلاعات کامل نیست، می‌تواند همان‌جا صدا ضبط کند و همان لیست را دوباره با AI بازبینی کند.
