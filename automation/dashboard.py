...
EVENTS = {
    ...
    "ui_dead_click": "فشار روی کنترل بدون شروع هیچ واکنشی",
    ...
    "browser_image_rejection_guidance_missing": "پیام ردشدن عکس، علت و راه تلاش دوباره را روشن نمی‌کند",
    "browser_validation_guidance_missing": "خطای وزن بسته‌بندی، فیلد و مسیر اصلاح را نشان نمی‌دهد",
    "browser_publish_failure_guidance_missing": "شکست ثبت محصول، علت قابل‌اقدام را نشان نمی‌دهد",
    "browser_control_occluded": "یک کنترل قابل‌مشاهده زیر لایهٔ دیگری گیر کرده است",
